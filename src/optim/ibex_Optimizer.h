...
public:
	...
	/***************************************************
	 * MODIFICACIÓN PARA MEDIR EL TIEMPO DE PYTHON!!! **
	 ***************************************************/

	/**
	* \brief Method that returns the time taken by the calling Python process 
	* to get the response of the model
	*/
	double get_python_time() const {
		return python_time;
	}

	/*******************************************************
	 * FIN MODIFICACIÓN PARA MEDIR EL TIEMPO DE PYTHON!!! **
	 *******************************************************/
...
private:
	 ...
	 ***************************************************/
	 ...
	 /* Time taken by Python model */
	double python_time;

	// Tiempo de reloj de pared
	double wall_time;
	std::chrono::high_resolution_clock::time_point start_wall_time;
